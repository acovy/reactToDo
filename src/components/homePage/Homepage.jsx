...
const Homepage = () => {
    return (
        <div className='body'>
            ...
            <div className='about'>
                <p>Добро пожаловать в <Link to="/todo">Todo</Link> - простое приложение для планирования задач, созданное для помощи в организации вашего дня.</p>
            ...
            <div className='etrance'>
                <h2>Для того чтобы начать пользоваться нажмите на кнопку <Link to="/todo">❮❮ START ❯❯</Link></h2>
            </div>
        </div>
    )
}
